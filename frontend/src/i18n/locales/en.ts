  ...
  admin: {
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        nonStreamKeepalive: 'Non-stream Keepalive',
        nonStreamKeepaliveHint: 'Default off. When enabled, long non-stream upstream JSON waits periodically write blank lines to reduce client or reverse-proxy idle timeouts.',
        nonStreamKeepaliveInterval: 'Keepalive Interval (seconds)',
        nonStreamKeepaliveIntervalHint: 'Default is 30 seconds; backend treats values <= 0 as 30 seconds.',
