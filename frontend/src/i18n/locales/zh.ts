  ...
  admin: {
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        nonStreamKeepalive: '非流式 Keepalive',
        nonStreamKeepaliveHint: '默认关闭。开启后，非流式上游长时间未返回完整 JSON 时会周期性写入空行，降低客户端或反向代理空闲超时概率。',
        nonStreamKeepaliveInterval: '保活间隔（秒）',
        nonStreamKeepaliveIntervalHint: '默认 30 秒；小于等于 0 时后端仍按 30 秒处理。',
