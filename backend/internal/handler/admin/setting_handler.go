...
func operatorSettingsUpdateRequest(input UpdateSettingsRequest, previousSettings *service.SystemSettings, previousAuthSourceDefaults *service.AuthSourceDefaultSettings) UpdateSettingsRequest {
	...
	if input.DefaultPlatformQuotas != nil {
		req.DefaultPlatformQuotas = input.DefaultPlatformQuotas
	}
...
func copyOperatorAuthSourceDefaults(target *UpdateSettingsRequest, source UpdateSettingsRequest) {
	...
	if source.AuthSourceEmailPlatformQuotas != nil {
		target.AuthSourceEmailPlatformQuotas = source.AuthSourceEmailPlatformQuotas
	}
	...
	if source.AuthSourceLinuxDoPlatformQuotas != nil {
		target.AuthSourceLinuxDoPlatformQuotas = source.AuthSourceLinuxDoPlatformQuotas
	}
	...
	if source.AuthSourceOIDCPlatformQuotas != nil {
		target.AuthSourceOIDCPlatformQuotas = source.AuthSourceOIDCPlatformQuotas
	}
	...
	if source.AuthSourceWeChatPlatformQuotas != nil {
		target.AuthSourceWeChatPlatformQuotas = source.AuthSourceWeChatPlatformQuotas
	}
	...
	if source.AuthSourceGitHubPlatformQuotas != nil {
		target.AuthSourceGitHubPlatformQuotas = source.AuthSourceGitHubPlatformQuotas
	}
	...
	if source.AuthSourceGooglePlatformQuotas != nil {
		target.AuthSourceGooglePlatformQuotas = source.AuthSourceGooglePlatformQuotas
	}
	...
	if source.AuthSourceDingTalkPlatformQuotas != nil {
		target.AuthSourceDingTalkPlatformQuotas = source.AuthSourceDingTalkPlatformQuotas
	}
